...
app_ui <- function(request) {
  tagList(
    ...
    navbarPage(title = div(img(src = "www/main-logo.png", height = "60px", alt = "Brookings logo")),
...
#                        h1('Visualize regional "opportunity zones"'),br(),
                        HTML("<p>Select variables of interest at the left and update map to view results. Warm and bright (yellow, orange) values and high ranks correspond to higher performing areas. Cool and dark colors (black, purple) correspond to lower performing areas. Click on any tract to get more information.</p>"),
#                        br(),
