...
mod_map_selections_ui <- function(id){
  ...
  tagList(
    ...
    shinyWidgets::pickerInput(ns("peopleInput"),
                              label = shiny::HTML(paste0("<h3>Equity & People</h3>", "<p style='font-size:16px'>Variables about people.</p>")), 
    ...
    shinyWidgets::pickerInput(ns("placeInput"),
                              label = shiny::HTML("<h3>Infrastructure & Environment</h3>", "<p style='font-size:16px'>Variables about the natural or built environment.</p>"), 
